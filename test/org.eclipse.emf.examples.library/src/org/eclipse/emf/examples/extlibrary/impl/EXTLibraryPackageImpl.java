...
public class EXTLibraryPackageImpl extends EPackageImpl implements EXTLibraryPackage
{
  ...
  public void initializePackageContents()
  {
		...
		// Create annotations
		// http://www.cohesionforce.com/search
		createSearchAnnotations();
		// http:///org/eclipse/emf/ecore/util/ExtendedMetaData
		createExtendedMetaDataAnnotations();
	}

  /**
	 * Initializes the annotations for <b>http://www.cohesionforce.com/search</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createSearchAnnotations() {
		String source = "http://www.cohesionforce.com/search"; //$NON-NLS-1$	
		addAnnotation
		  (bookEClass, 
		   source, 
		   new String[] {
			 "index", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });	
		addAnnotation
		  (getBook_Title(), 
		   source, 
		   new String[] {
			 "tokenize", "true" //$NON-NLS-1$ //$NON-NLS-2$
		   });	
		addAnnotation
		  (libraryEClass, 
		   source, 
