...
public class Book extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public avro.extlibrary.BookCategory category;
   ...
   */
  public Book(java.lang.CharSequence publicationDate, java.lang.Integer copies, java.util.List<avro.extlibrary.Borrower> borrowers, java.lang.CharSequence title, java.lang.Integer pages, avro.extlibrary.BookCategory category, avro.extlibrary.Writer author) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: category = (avro.extlibrary.BookCategory)value$; break;
    case 6: author = (avro.extlibrary.Writer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public avro.extlibrary.BookCategory getCategory() {
    return category;
  }
   ...
   * @param value the value to set.
   */
  public void setCategory(avro.extlibrary.BookCategory value) {
    this.category = value;
  }
  ...
  public static avro.extlibrary.Book.Builder newBuilder() {
    return new avro.extlibrary.Book.Builder();
  }
  
  /** Creates a new Book RecordBuilder by copying an existing Builder */
  public static avro.extlibrary.Book.Builder newBuilder(avro.extlibrary.Book.Builder other) {
    return new avro.extlibrary.Book.Builder(other);
  }
  
  /** Creates a new Book RecordBuilder by copying an existing Book instance */
  public static avro.extlibrary.Book.Builder newBuilder(avro.extlibrary.Book other) {
    return new avro.extlibrary.Book.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Book>
    ...
    private int pages;
    private avro.extlibrary.BookCategory category;
    private avro.extlibrary.Writer author;

    /** Creates a new Builder */
    private Builder() {
      super(avro.extlibrary.Book.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.extlibrary.Book.Builder other) {
      super(other);
    ...
    private Builder(avro.extlibrary.Book other) {
            super(avro.extlibrary.Book.SCHEMA$);
      if (isValidValue(fields()[0], other.publicationDate)) {
        this.publicationDate = data().deepCopy(fields()[0].schema(), other.publicationDate);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'publicationDate' field */
    public avro.extlibrary.Book.Builder setPublicationDate(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Book.Builder clearPublicationDate() {
    ...
    /** Sets the value of the 'copies' field */
    public avro.extlibrary.Book.Builder setCopies(int value) {
    ...
    public avro.extlibrary.Book.Builder clearCopies() {
    ...
    /** Sets the value of the 'borrowers' field */
    public avro.extlibrary.Book.Builder setBorrowers(java.util.List<avro.extlibrary.Borrower> value) {
    ...
    public avro.extlibrary.Book.Builder clearBorrowers() {
      borrowers = null;
    ...
    /** Sets the value of the 'title' field */
    public avro.extlibrary.Book.Builder setTitle(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Book.Builder clearTitle() {
      title = null;
    ...
    /** Sets the value of the 'pages' field */
    public avro.extlibrary.Book.Builder setPages(int value) {
    ...
    public avro.extlibrary.Book.Builder clearPages() {
    ...
    /** Sets the value of the 'category' field */
    public avro.extlibrary.Book.Builder setCategory(avro.extlibrary.BookCategory value) {
    ...
    public avro.extlibrary.Book.Builder clearCategory() {
      category = null;
    ...
    /** Sets the value of the 'author' field */
    public avro.extlibrary.Book.Builder setAuthor(avro.extlibrary.Writer value) {
    ...
    public avro.extlibrary.Book.Builder clearAuthor() {
      author = null;
    ...
    public Book build() {
      try {
        ...
        record.category = fieldSetFlags()[5] ? this.category : (avro.extlibrary.BookCategory) defaultValue(fields()[5]);
        record.author = fieldSetFlags()[6] ? this.author : (avro.extlibrary.Writer) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
