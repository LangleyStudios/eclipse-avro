...
public class CirculatingItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CirculatingItem(java.lang.CharSequence publicationDate, java.lang.Integer copies, java.util.List<avro.extlibrary.Borrower> borrowers) {
  ...
  public static avro.extlibrary.CirculatingItem.Builder newBuilder() {
    return new avro.extlibrary.CirculatingItem.Builder();
  }
  
  /** Creates a new CirculatingItem RecordBuilder by copying an existing Builder */
  public static avro.extlibrary.CirculatingItem.Builder newBuilder(avro.extlibrary.CirculatingItem.Builder other) {
    return new avro.extlibrary.CirculatingItem.Builder(other);
  }
  
  /** Creates a new CirculatingItem RecordBuilder by copying an existing CirculatingItem instance */
  public static avro.extlibrary.CirculatingItem.Builder newBuilder(avro.extlibrary.CirculatingItem other) {
    return new avro.extlibrary.CirculatingItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CirculatingItem>
    ...
    private Builder() {
      super(avro.extlibrary.CirculatingItem.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.extlibrary.CirculatingItem.Builder other) {
      super(other);
    ...
    private Builder(avro.extlibrary.CirculatingItem other) {
            super(avro.extlibrary.CirculatingItem.SCHEMA$);
      if (isValidValue(fields()[0], other.publicationDate)) {
        this.publicationDate = data().deepCopy(fields()[0].schema(), other.publicationDate);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'publicationDate' field */
    public avro.extlibrary.CirculatingItem.Builder setPublicationDate(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.CirculatingItem.Builder clearPublicationDate() {
    ...
    /** Sets the value of the 'copies' field */
    public avro.extlibrary.CirculatingItem.Builder setCopies(int value) {
    ...
    public avro.extlibrary.CirculatingItem.Builder clearCopies() {
    ...
    /** Sets the value of the 'borrowers' field */
    public avro.extlibrary.CirculatingItem.Builder setBorrowers(java.util.List<avro.extlibrary.Borrower> value) {
    ...
    public avro.extlibrary.CirculatingItem.Builder clearBorrowers() {
      borrowers = null;
