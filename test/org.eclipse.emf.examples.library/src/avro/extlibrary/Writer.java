...
public class Writer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Writer(java.lang.CharSequence address, java.lang.CharSequence firstName, java.lang.CharSequence lastName, java.lang.CharSequence name, java.util.List<avro.extlibrary.Book> books) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: books = (java.util.List<avro.extlibrary.Book>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static avro.extlibrary.Writer.Builder newBuilder() {
    return new avro.extlibrary.Writer.Builder();
  }
  
  /** Creates a new Writer RecordBuilder by copying an existing Builder */
  public static avro.extlibrary.Writer.Builder newBuilder(avro.extlibrary.Writer.Builder other) {
    return new avro.extlibrary.Writer.Builder(other);
  }
  
  /** Creates a new Writer RecordBuilder by copying an existing Writer instance */
  public static avro.extlibrary.Writer.Builder newBuilder(avro.extlibrary.Writer other) {
    return new avro.extlibrary.Writer.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Writer>
    ...
    private Builder() {
      super(avro.extlibrary.Writer.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.extlibrary.Writer.Builder other) {
      super(other);
    ...
    private Builder(avro.extlibrary.Writer other) {
            super(avro.extlibrary.Writer.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'address' field */
    public avro.extlibrary.Writer.Builder setAddress(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Writer.Builder clearAddress() {
      address = null;
    ...
    /** Sets the value of the 'firstName' field */
    public avro.extlibrary.Writer.Builder setFirstName(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Writer.Builder clearFirstName() {
      firstName = null;
    ...
    /** Sets the value of the 'lastName' field */
    public avro.extlibrary.Writer.Builder setLastName(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Writer.Builder clearLastName() {
      lastName = null;
    ...
    /** Sets the value of the 'name' field */
    public avro.extlibrary.Writer.Builder setName(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Writer.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'books' field */
    public avro.extlibrary.Writer.Builder setBooks(java.util.List<avro.extlibrary.Book> value) {
    ...
    public avro.extlibrary.Writer.Builder clearBooks() {
      books = null;
    ...
    public Writer build() {
      try {
        ...
        record.books = fieldSetFlags()[4] ? this.books : (java.util.List<avro.extlibrary.Book>) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
