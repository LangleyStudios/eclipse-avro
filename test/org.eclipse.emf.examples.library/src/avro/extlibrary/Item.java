...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"avro.extlibrary\",\"fields\":[{\"name\":\"publicationDate\",\"type\":\"string\"}]}");
  ...
  public static avro.extlibrary.Item.Builder newBuilder() {
    return new avro.extlibrary.Item.Builder();
  }
  
  /** Creates a new Item RecordBuilder by copying an existing Builder */
  public static avro.extlibrary.Item.Builder newBuilder(avro.extlibrary.Item.Builder other) {
    return new avro.extlibrary.Item.Builder(other);
  }
  
  /** Creates a new Item RecordBuilder by copying an existing Item instance */
  public static avro.extlibrary.Item.Builder newBuilder(avro.extlibrary.Item other) {
    return new avro.extlibrary.Item.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
    ...
    private Builder() {
      super(avro.extlibrary.Item.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.extlibrary.Item.Builder other) {
      super(other);
    ...
    private Builder(avro.extlibrary.Item other) {
            super(avro.extlibrary.Item.SCHEMA$);
      if (isValidValue(fields()[0], other.publicationDate)) {
        this.publicationDate = data().deepCopy(fields()[0].schema(), other.publicationDate);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'publicationDate' field */
    public avro.extlibrary.Item.Builder setPublicationDate(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.Item.Builder clearPublicationDate() {
