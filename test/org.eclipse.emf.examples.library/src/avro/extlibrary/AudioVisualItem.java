...
public class AudioVisualItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AudioVisualItem(java.lang.CharSequence publicationDate, java.lang.Integer copies, java.util.List<avro.extlibrary.Borrower> borrowers, java.lang.CharSequence title, java.lang.Integer minutesLength, java.lang.Boolean damaged) {
  ...
  public static avro.extlibrary.AudioVisualItem.Builder newBuilder() {
    return new avro.extlibrary.AudioVisualItem.Builder();
  }
  
  /** Creates a new AudioVisualItem RecordBuilder by copying an existing Builder */
  public static avro.extlibrary.AudioVisualItem.Builder newBuilder(avro.extlibrary.AudioVisualItem.Builder other) {
    return new avro.extlibrary.AudioVisualItem.Builder(other);
  }
  
  /** Creates a new AudioVisualItem RecordBuilder by copying an existing AudioVisualItem instance */
  public static avro.extlibrary.AudioVisualItem.Builder newBuilder(avro.extlibrary.AudioVisualItem other) {
    return new avro.extlibrary.AudioVisualItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AudioVisualItem>
    ...
    private Builder() {
      super(avro.extlibrary.AudioVisualItem.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.extlibrary.AudioVisualItem.Builder other) {
      super(other);
    ...
    private Builder(avro.extlibrary.AudioVisualItem other) {
            super(avro.extlibrary.AudioVisualItem.SCHEMA$);
      if (isValidValue(fields()[0], other.publicationDate)) {
        this.publicationDate = data().deepCopy(fields()[0].schema(), other.publicationDate);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'publicationDate' field */
    public avro.extlibrary.AudioVisualItem.Builder setPublicationDate(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.AudioVisualItem.Builder clearPublicationDate() {
    ...
    /** Sets the value of the 'copies' field */
    public avro.extlibrary.AudioVisualItem.Builder setCopies(int value) {
    ...
    public avro.extlibrary.AudioVisualItem.Builder clearCopies() {
    ...
    /** Sets the value of the 'borrowers' field */
    public avro.extlibrary.AudioVisualItem.Builder setBorrowers(java.util.List<avro.extlibrary.Borrower> value) {
    ...
    public avro.extlibrary.AudioVisualItem.Builder clearBorrowers() {
      borrowers = null;
    ...
    /** Sets the value of the 'title' field */
    public avro.extlibrary.AudioVisualItem.Builder setTitle(java.lang.CharSequence value) {
    ...
    public avro.extlibrary.AudioVisualItem.Builder clearTitle() {
      title = null;
    ...
    /** Sets the value of the 'minutesLength' field */
    public avro.extlibrary.AudioVisualItem.Builder setMinutesLength(int value) {
    ...
    public avro.extlibrary.AudioVisualItem.Builder clearMinutesLength() {
    ...
    /** Sets the value of the 'damaged' field */
    public avro.extlibrary.AudioVisualItem.Builder setDamaged(boolean value) {
    ...
    public avro.extlibrary.AudioVisualItem.Builder clearDamaged() {
