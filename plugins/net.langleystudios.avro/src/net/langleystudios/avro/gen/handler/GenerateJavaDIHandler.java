...
public class GenerateJavaDIHandler extends AbstractHandler {

	GenerateJavaHandler handler;
	public GenerateJavaDIHandler() {
		 IEclipseContext context = getActiveContext();
		 handler = ContextInjectionFactory.make(GenerateJavaHandler.class, context);
	}
